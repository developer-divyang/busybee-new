            ...
            <div class="optFilter">
                ...
                <div style="display: flex;flex-wrap: wrap; gap:8px;">
                    ...
                    <div class="custom-select">
                        <select id="g3" name="g3" onchange="constantCalculation()">
                    ...
                    <div class="custom-select">
                        ...
                        <select id="h3" name="h3" onchange="constantCalculation()">
                ...
                <div style="display: flex;flex-wrap: wrap; gap:8px">
                    <div class="custom-select" id="side_location" style="display: none;">
                        <select id="j3" name="j3" onchange="constantCalculation()">
                    ...
                    <!-- ----------------------- -->
                    <div class="custom-select" id="back_location" style="display: none;">
                        <select id="l3" name="l3" onchange="constantCalculation()">
