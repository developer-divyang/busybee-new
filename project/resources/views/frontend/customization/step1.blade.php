                                    ...
                                    <div class="accorBoxRight">
                                        ...
                                        <div class="sizeBox">
                                            ...
                                            <div style="margin-top:10px; ">
                                                ...
                                                <p style="padding:5px; border:1.5px solid rgba(0,0,0,0.3); border-radius:10px; text-align:center">Size: {{ $size_n->size_name }}</p>
                                                <div class="counter">
                                                    <button type="button" class="counter-btn minus-btn">−</button>
                                                    <input type="text" class="quantity-input" name="quantity[{{$pcolor->color_id}}][{{$size_n->id}}][]" value="0" readonly>
...
<script>
    ...
    function updateF3Value() {
        ...
        $('#f3').val(totalQuantity); // Assuming #f3 is an input or element that holds the f3 value
    }
