...
/////////////////////////////// ////////////////////////////////////////////
  ...
  Route::post('/products/variation-combination', 'Admin\ProductController@variationCombination')->name('admin-products-sku-combination');
...
Route::post('/products/store', 'Admin\ProductController@store')->name('admin-prod-store');
  ...
  Route::get('/products/constant/edit/{id}', 'Admin\ProductController@editConstant')->name('admin-prod-constant-edit');
  Route::get('/products/user/price/{id}', 'Admin\ProductController@checkUserPrice')->name('check-user-price');
  
  Route::post('/products/constant/update/{id}', 'Admin\ProductController@updateConstant')->name('admin-prod-constant-update');
...
// -------------------- Reward Section Route ---------------------//
  ...
  //Admin model number section
  Route::get('/model-number/datatables','Admin\ModelController@datatables')->name('admin.model.datatables');
  Route::get('/model-number','Admin\ModelController@index')->name('admin.model.index');
  Route::get('/model-number/create', 'Admin\ModelController@create')->name('admin.model.create');
  Route::post('/model-number/create', 'Admin\ModelController@store')->name('admin.model.store');
  Route::get('/model-number/edit/{id}', 'Admin\ModelController@edit')->name('admin.model.edit');
  Route::post('/model-number/edit/{id}', 'Admin\ModelController@update')->name('admin.model.update');
  Route::delete('/model-number/delete/{id}', 'Admin\ModelController@destroy')->name('admin.model.delete');
  Route::get('/model-number/status/{id}', 'Admin\ModelController@status')->name('admin.model.status');
  //Admin model number section ends
...
Route::post('/item/report', 'Front\CatalogController@report')->name('product.report');
  ...
  Route::post('product/color-images', [CatalogController::class, 'getColorImages'])->name('front.product.colorImages');
  Route::post('/filter-products', [CatalogController::class, 'filterProducts'])->name('front.filter.products');
  //search product
  Route::post('/recommendations', [CatalogController::class, 'searchProduct'])->name('front.search.products');
